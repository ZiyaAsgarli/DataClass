/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=WorkerBindings worker/worker-configuration.d.ts` (hash: 4ee9dcd6b46218c7b84899f1fb42f3fe)
// Runtime types generated with workerd@1.20260811.1 2026-08-16 nodejs_compat
interface __BaseEnv_WorkerBindings {
	B2_KEY_ID: string;
	B2_APPLICATION_KEY: string;
	APP_ORIGIN?: "http://localhost:5173";
	NEON_DATA_API_URL?: "https://ep-steep-truth-b11n2txh.apirest.c-5.eu-central-1.aws.neon.tech/neondb/rest/v1";
	B2_BUCKET_NAME?: "dataclass-resources";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "B2_KEY_ID" | "B2_APPLICATION_KEY" | "APP_ORIGIN" | "NEON_DATA_API_URL" | "B2_BUCKET_NAME" | "B2_S3_ENDPOINT" | "B2_REGION">> {}
}
