...
const NotFoundPage = lazy(() =>
  import("@/pages/shared/NotFoundPage").then((module) => ({
    default: module.NotFoundPage,
  })),
);
const StudentClassPage = lazy(() =>
  import("@/pages/student/StudentClassPage").then((module) => ({
    default: module.StudentClassPage,
  })),
);
const StudentAssignmentDetailPage = lazy(() =>
  import("@/pages/student/StudentAssignmentDetailPage").then((module) => ({
...
const StudentLessonPage = lazy(() =>
  import("@/pages/student/StudentLessonPage").then((module) => ({
    default: module.StudentLessonPage,
  })),
);
const StudentModulePage = lazy(() =>
  import("@/pages/student/StudentModulePage").then((module) => ({
    default: module.StudentModulePage,
  })),
);
...
const TeacherAssignmentDetailPage = lazy(() =>
  import("@/pages/teacher/TeacherAssignmentDetailPage").then((module) => ({
...
const TeacherLessonPage = lazy(() =>
  import("@/pages/teacher/TeacherLessonPage").then((module) => ({
    default: module.TeacherLessonPage,
  })),
);
const TeacherModulePage = lazy(() =>
  import("@/pages/teacher/TeacherModulePage").then((module) => ({
    default: module.TeacherModulePage,
  })),
);
const TeacherSubmissionPage = lazy(() =>
  import("@/pages/teacher/TeacherSubmissionPage").then((module) => ({
    default: module.TeacherSubmissionPage,
  })),
);
    ...
    <BrowserRouter>
      <Suspense fallback={<RouteLoading />}>
        <Routes>
          ...
          />
          <Route
            path="/teacher/classes/:classId/modules/:moduleId"
            element={
              <ProtectedRoute role="teacher">
                <TeacherModulePage />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/teacher/classes/:classId/modules/:moduleId/lessons/:lessonId"
            element={
              <ProtectedRoute role="teacher">
                <TeacherLessonPage />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/student/classes/:classId/modules/:moduleId"
            element={
              <ProtectedRoute role="student">
                <StudentModulePage />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/student/classes/:classId/modules/:moduleId/lessons/:lessonId"
            element={
              <ProtectedRoute role="student">
                <StudentLessonPage />
              </ProtectedRoute>
