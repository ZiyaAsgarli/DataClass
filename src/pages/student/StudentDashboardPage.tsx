...
import { classes, studentActivity, studentAssignments } from "@/data/mockData";
import { useAuth } from "@/hooks/useAuth";
import { AppShell } from "@/layouts/AppShell";

export function StudentDashboardPage() {
  const modules = classes[0].modules;
  ...
  return (
    <AppShell role="student" title="Overview">
          ...
          <div className="grid lg:grid-cols-[1fr_300px]">
            <div className="p-5 sm:p-7">
              ...
              <p className="mt-2 max-w-xl text-sm leading-6 text-muted-foreground">
                Learn how to find, match, and combine data across worksheets
                with modern lookup tools.
              </p>
            ...
            <div className="hidden border-l bg-muted/35 p-7 lg:flex lg:flex-col lg:justify-between">
      ...
      <div className="mt-8 grid gap-8 xl:grid-cols-2">
        <section>
          <SectionHeader
            ...
            description="Data Analytics — Batch 01"
          />
                ...
                <div className="min-w-0 flex-1">
                  <div className="mb-2 flex justify-between text-sm">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {module.locked ? "Locked" : `${module.progress}%`}
                    </span>
                  </div>
        ...
        <section>
          <SectionHeader
            ...
            description="Stay ahead of your due dates"
          />
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      Due {item.date} · {item.submissions}
                    </p>
                  </div>
                </div>
                <Badge
      ...
      <section className="mt-8">
        ...
        />
        <Card className="p-5">
          <ActivityList items={studentActivity} />
        </Card>
      </section>
    </AppShell>
  );
